...
public final class LocustMax implements Player {

	static final String _CNAME = "Locust Max";
	static final Color _CColor = new Color(0.0f, 0.00f, 1.00f);
	private int state;
	private Random rand;
