...
public final class LocustAggressive2 implements Player {

	static final String _CNAME = "Locust Aggressive 2";
	static final Color _CColor = new Color(0.90f, 0.90f, 1.00f);
	private int state;
	private Random rand;
